...
export default class ClinicSummary extends Component {
  ...
  getClinicsFromIcbCode() {
    ...
    axios
      .get(
        `https://ysrkj0zing.execute-api.eu-west-2.amazonaws.com/dev/clinic-summary-list?participatingIcb=${this.context.state.icbSelected}`
      )
      .then((response) => {
  ...
  async componentDidMount() {
    try {
      ...
      const response = await axios.get(
        `https://iajb6ya6ed.execute-api.eu-west-2.amazonaws.com/dev/participating-icb-list`
      );
