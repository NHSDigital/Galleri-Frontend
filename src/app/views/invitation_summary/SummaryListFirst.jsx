    ...
    return (
      <dl id="summary-list-1" class="nhsuk-summary-list nhsuk-u-margin-bottom-9">
        <div class="nhsuk-summary-list__row">
          <dt id="term3-label" class="nhsuk-summary-list__key nhsuk-summary-list-custom__key">
        ...
        <div class="nhsuk-summary-list__row">
          <dt id="term4-label" class="nhsuk-summary-list__key nhsuk-summary-list-custom__key">
            Target percentage of appointments to fill
          </dt>
          <dd
            id="term4-value"
            class="nhsuk-summary-list__value nhsuk-u-padding-left-4 nhsuk-summary-list__value_custom__value"
          >
            {targetPercentageToFill}%
          </dd>
        </div>
        <div class="nhsuk-summary-list__row">
          <dt id="term5-label" class="nhsuk-summary-list__key nhsuk-summary-list-custom__key">
        ...
        <div class="nhsuk-summary-list__row">
          <dt id="term2-label" class="nhsuk-summary-list__key nhsuk-summary-list-custom__key">
