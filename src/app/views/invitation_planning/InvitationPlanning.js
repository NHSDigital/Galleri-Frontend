...
class InvitationPlanning extends Component {
  ...
  async putForecastUptakeAWSDynamo(value) {
    ...
    await axios
      .put(
        "https://pc7tbxmzyj.execute-api.eu-west-2.amazonaws.com/dev/invitation-parameters-put-forecast-uptake",
  ...
  async putQuintilesAWSDynamo(updatedQuintile) {
    ...
    await axios
      .put(
        "https://pc7tbxmzyj.execute-api.eu-west-2.amazonaws.com/dev/invitation-parameters-put-quintiles",
  ...
  componentDidMount() {
    ...
    axios
      .get(
        "https://pc7tbxmzyj.execute-api.eu-west-2.amazonaws.com/dev/invitation-parameters"
      )
      .then((response) => {
        console.log("response -> " + response.status);
        const quintiles = [
